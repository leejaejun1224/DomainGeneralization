...
source_train['prior'] = f'~/dataset/{source_dataset}/disparity_distribution_{source_dataset}.npy'
...
source_val['prior'] = f'~/dataset/{source_dataset}/disparity_distribution_{source_dataset}.npy'
...
source_test['prior'] = f'~/dataset/{source_dataset}/disparity_distribution_{source_dataset}.npy'
...
target_train['prior'] = f'~/dataset/{target_dataset}/disparity_distribution_{target_dataset}.npy'
...
target_val['prior'] = f'~/dataset/{target_dataset}/disparity_distribution_{target_dataset}.npy'
...
target_test['prior'] = f'~/dataset/{target_dataset}/disparity_distribution_{target_dataset}.npy'
