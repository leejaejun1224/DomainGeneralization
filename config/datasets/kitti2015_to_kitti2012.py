...
dataset = dict(
    train = dict(
        type='UDAdataset',
        source=dict(
            data_root=f'~/dataset/kitti/{source_dataset}/training',
        ...
        target=dict(
            data_root=f'~/dataset/kitti/{target_dataset}/training',
            left_img_dir='image_2',
            right_img_dir='image_3',
    ...
    val = dict(
        type='UDAdataset',
        source=dict(
            data_root=f'~/dataset/kitti/{source_dataset}/testing',
            left_img_dir='image_2',
            right_img_dir='image_3',
            ann_dir='2015 disparity gt 저장된 곳',
        ...
        target=dict(
            data_root=f'~/dataset/kitti/{target_dataset}/testing',
            left_img_dir='image_2',
            right_img_dir='image_3',
            ann_dir='2012 disparity gt 저장된 곳',
