...
class KITTI2015Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.training:
            ...
            processed_strong_aug = get_transform(strong_aug=True)
            left_img_strong_aug = processed_strong_aug(left_img)
            right_img_strong_aug = processed_strong_aug(left_img)
            ...
            return {"left": left_img,
                    "right": right_img,
                    "left_strong_aug": left_img_strong_aug,
                    "right_strong_aug": right_img_strong_aug,
